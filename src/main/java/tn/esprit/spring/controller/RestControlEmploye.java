...
public class RestControlEmploye {
 ...
 // Modifier email : http://localhost:8081/SpringMVC/servlet/mettreAjourEmailByEmployeIdJPQL/2/newemail
	...
	@GetMapping(value = "/getEmployeByMissionAndDat/{idemp}/{idmiss}/{date}")
    @ResponseBody
	public List<Timesheet> getTimesheetsByMissionAndDate(@PathVariable("idemp")Employe employe,@PathVariable("idmiss") Mission mission,@PathVariable("date") Date dateDebut,
			Date dateFin) {
